...
When camila quiere validar que al seleccionar un elemento en el campo para que quieres ahorrar pero saldra un error el cual "Se espera un valor igual a 3"
Then elegir un elemento desde el archivo excel pero entonces saldra un error <errorMessage>
